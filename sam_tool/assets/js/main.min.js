...
var arrowMainMenu1=$('.arrow-main-menu1');for(var i=0;i<arrowMainMenu1.length;i++){$(arrowMainMenu1[i]).on('click',function(){$(this).parent().find('.sub-menu1').slideToggle();$(this).toggleClass('turn-arrow');})}
